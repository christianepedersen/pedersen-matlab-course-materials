...
x1 = input('Pick a positive integer: ')
...
sucroMat = periAllEvents2(chocoFlag==0,:);
...
chocoMeans = mean(chocoMat(:,20:28),2)

sucroMeans = mean(sucroMat(:,20:28),2)
...
[h,p] = ttest2(chocoMeans,sucroMeans)
